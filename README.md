...
🗣️  Whisper.cpp (Speech-to-Text)
    ↓
🤖 LLaMA 3.2 1B (Chat AI with streaming)
    ↓
...
- ✅ Downloads LLaMA 3.2 1B model (~800 MB)
- ✅ Downloads Piper TTS voice model (~63 MB)
- ✅ Configures paths for your OS

**First run may take 5-10 minutes** depending on your internet speed.
...
# Download LLaMA 3.2 1B Instruct Q4_K_M (~800 MB)
...
LLAMA_MODEL_PATH = "/home/YOUR_USER/llama.cpp/models/Llama-3.2-1B-Instruct-Q4_K_M.gguf"
...
Invoke-WebRequest -Uri "https://huggingface.co/lmstudio-community/Llama-3.2-1B-Instruct-GGUF/resolve/main/Llama-3.2-1B-Instruct-Q4_K_M.gguf" -OutFile "Llama-3.2-1B-Instruct-Q4_K_M.gguf"
```
...
LLAMA_MODEL_PATH = "C:/Users/YourUser/llama_models/Llama-3.2-1B-Instruct-Q4_K_M.gguf"
...
LLAMA_MODEL_PATH = "/Users/YOUR_USER/llama_models/Llama-3.2-1B-Instruct-Q4_K_M.gguf"
...
~/llama.cpp/models/
└── Llama-3.2-1B-Instruct-Q4_K_M.gguf  # LLaMA model
